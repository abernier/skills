...
- [#59](https://github.com/abernier/skills/pull/59) [`6dfdeae`](https://github.com/abernier/skills/commit/6dfdeae83283d0dcefbaaf39b8907d6c1efc64d8) Thanks [@abernier](https://github.com/abernier)! - `local-gate-report` — a new bin that tells GitHub this machine ran a gate on a
  commit.
...
- [#36](https://github.com/abernier/skills/pull/36) [`a59795b`](https://github.com/abernier/skills/commit/a59795bb6c49bc10eb3592fa58a66fcffae3a491) Thanks [@abernier](https://github.com/abernier)! - The profiler's two legs start the same way.
...
- [#55](https://github.com/abernier/skills/pull/55) [`e4fce3e`](https://github.com/abernier/skills/commit/e4fce3e198e0e9e3dcdf98f793e02f39769461aa) Thanks [@abernier](https://github.com/abernier)! - Two new bins, `i18n-check` and `i18n-merge`, for a react-intl repo with a
...
- [#52](https://github.com/abernier/skills/pull/52) [`68b74ff`](https://github.com/abernier/skills/commit/68b74ff69d9805dfb9acf1e1514e2c3f246aa949) Thanks [@abernier](https://github.com/abernier)! - fix(profiler): gzip the cached commit log
...
- [#50](https://github.com/abernier/skills/pull/50) [`f8beb36`](https://github.com/abernier/skills/commit/f8beb365f5ab3c8911d463a4508a4e21cdd2b92d) Thanks [@abernier](https://github.com/abernier)! - perf(profiler): measure the control side once, then reuse it
...
- [#48](https://github.com/abernier/skills/pull/48) [`fe63f66`](https://github.com/abernier/skills/commit/fe63f66265a58139c56c673be48aa088e7a45252) Thanks [@abernier](https://github.com/abernier)! - A step that rendered nothing on the control and renders on this branch now
  fails the PR.
...
- [#45](https://github.com/abernier/skills/pull/45) [`30265dc`](https://github.com/abernier/skills/commit/30265dcff17a218635164fac731a7504c9455f04) Thanks [@abernier](https://github.com/abernier)! - A bench leg that failed its own assertions no longer reads as a pass.
...
- [#43](https://github.com/abernier/skills/pull/43) [`2bd8e06`](https://github.com/abernier/skills/commit/2bd8e06714af5eb675d1abeac25ae019648b570b) Thanks [@abernier](https://github.com/abernier)! - A bench now waits for a bench running in **another** repo, where before it ran
  alongside it.
